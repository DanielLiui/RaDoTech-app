/****************************************************************************
** Meta object code from reading C++ file 'resultstab.h'
**
...
#include <memory>
#include "../../include/resultstab.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'resultstab.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject ResultsTab::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ResultsTab.data,
    qt_meta_data_ResultsTab,
    qt_static_metacall,
    nullptr,
    nullptr
} };
